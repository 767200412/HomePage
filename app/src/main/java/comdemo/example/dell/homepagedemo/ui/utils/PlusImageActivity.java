...
public class PlusImageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgList = getIntent().getStringArrayListExtra(NumberConstant.IMG_LIST);
        mPosition = getIntent().getIntExtra(NumberConstant.POSITION, 0);
        initView();
    }
    ...
    private void back() {
        ...
        intent.putStringArrayListExtra(NumberConstant.IMG_LIST, imgList);
        setResult(NumberConstant.RESULT_CODE_VIEW_IMG, intent);
        finish();
    }
